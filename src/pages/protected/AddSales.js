  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        var sampleProducts_data = response.data.products.map((product) => ({
          id: product.id,
          product_name: product.product_name,
          unit_price: product.unit_price,
          quantity: product.quantity, // Assuming quantity is part of the product data
          // imageUrl: product.imageUrl, // If you have an image URL
        }));
        // sampleProducts.push(...sampleProducts_data);
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          ...
          <select
            ...
            onChange={(e) =>
              ...
              addProduct(displayproducts.find((p) => p.id == e.target.value))
            }
          >
            <option value="">Select Product</option>
            {displayproducts.map((product) => (
              // console.log("Product amadi>>>")
          ...
          <table className="w-full border">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="p-2 text-left">Quantity Left</th>
                <th className="p-2 text-left">Unit Price</th>
                <th className="p-2 text-left">Product Code No</th>
                ...
                <tr key={index} className="border-b">
                  ...
                  <td className="p-2">
                    ...
                    <button
                      ...
                      className="bg-green-300 ml-6 text-white px-3 py-1 rounded-md hover:bg-red-600 transition duration-200"
                    >
                      Add
                    </button>
                  </td>
